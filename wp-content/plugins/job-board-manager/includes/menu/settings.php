...
/*
* @Author 		ParaTheme
* @Folder	 	job-board-manager/includes/menu
...
*/									
			...
			$options['Pages'] = array(
								'job_bm_archive_page_id'=>array(
									...
									'title'=>'Archive Page',
									'option_details'=>'Archive Page(Job list page where placed the short-code [job_list])',						
								...
								'job_bm_job_submit_page_id'=>array(
									...
									'title'=>'Job Submit Page',
									'option_details'=>'Job Submission Page',						
									'input_type'=>'select', // text, radio, checkbox, select, 
									'input_values'=>'', // could be array
									'input_args'=>job_bm_page_list_id(), // could be array									
									),
...
*/									
			...
			$options['Job Post'] = array(
								...
								'job_bm_reCAPTCHA_site_key'=>array(
									...
									'option_details'=>'reCAPTCHA site key, please go <a href="https://www.google.com/recaptcha">google.com/reCAPTCHA</a> and register your site to get site key.',						
									'input_type'=>'text', // text, radio, checkbox, select, 
									'input_values'=> '', // could be array
									),		
								...
								'job_bm_reCAPTCHA_secret_key'=>array(
									...
									'option_details'=>'reCAPTCHA site key, please go <a href="https://www.google.com/recaptcha">google.com/reCAPTCHA</a> and register your site to get secret key.',						
									'input_type'=>'text', // text, radio, checkbox, select, 
									'input_values'=> '', // could be array
									),									
								...
								'job_bm_submitted_job_status'=>array(
									...
									'title'=>'New Submitted Job Status ?',
									'option_details'=>'Submitted Job Status',						
									'input_type'=>'select', // text, radio, checkbox, select, 
									'input_values'=> 'pending', // could be array
									'input_args'=> array( 'draft'=>'Draft', 'pending'=>'Pending', 'publish'=>'Published', 'private'=>'Private' , 'trash'=>'trash'),
									),
...
*/
			...
			$section_options = array(
								...
								'job_bm_logo_url'=>array(
									...
									'option_details'=>'Email Logo URL',						
									'input_type'=>'file', // text, radio, checkbox, select, 
									'input_values'=>job_bm_plugin_url.'css/email.png', // could be array
									),
									
								'job_bm_from_email'=>array(
									'css_class'=>'from_email',					
									'title'=>'From Email',
									'option_details'=>'From Email Address',						
									'input_type'=>'text', // text, radio, checkbox, select, 
									'input_values'=>'', // could be array
									),	
								...
								'job_bm_notify_email_job_submit'=>array(
									...
									'title'=>'Notify email new job submit ?',
									'option_details'=>'Notify email new job submit',						
									'input_type'=>'select', // text, radio, checkbox, select, 
			...
			$options['Style'] = array(
								...
								'job_bm_job_type_bg_color'=>array(
									...
									'input_values'=> '', // could be array
									'input_args'=> apply_filters('job_bm_filters_job_type_bg_color', array('freelance'=>'#46a6ff','full-time'=>'#2ec274','internship'=>'#a066ff','part-time'=>'#ffc24d','temporary'=>'#ff5741'))
									),
								...
								'job_bm_job_status_bg_color'=>array(
									...
									'input_type'=>'text-multi', // text, radio, checkbox, select, 
									'input_values'=> '', // could be array
									'input_args'=> apply_filters('job_bm_filters_job_status_bg_color', array('open'=>'#3ac170','closed'=>'#fa3218','filled'=>'#49a2ed','re-open'=>'#2fc2f9' ,'expired'=>'#ff4115'))
									),								
	...
	public function job_bm_settings_options_form(){
			...
			foreach($options as $option_key=>$option_info){
				...
				elseif($option_info['input_type'] == 'file'){
					...
					$html_box.= '<br /><br /><div style="overflow:hidden;max-height:150px;max-width:150px;" class="logo-preview"><img src="'.$option_value.'" /></div>';
...
if(empty($_POST['job_bm_hidden']))
	...
	{	
		if($_POST['job_bm_hidden'] == 'Y') {
			...
			?>
			<div class="updated"><p><strong><?php _e('Changes Saved.', 'job_bm' ); ?></strong></p></div>
...
<div class="wrap">
	...
	<div id="icon-tools" class="icon32"><br></div><?php echo "<h2>".__(job_bm_plugin_name.' Settings', 'job_bm')."</h2>";?>
...
<p class="submit">
                    <input class="button button-primary" type="submit" name="Submit" value="<?php _e('Save Changes','job_bm' ); ?>" />
                </p>
		</form>
