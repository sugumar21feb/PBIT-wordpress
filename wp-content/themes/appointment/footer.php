...
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
        <script>window.jQuery || document.write('<script src="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/js/vendor/jquery-1.10.2.min.js"><\/script>')</script>
        <script src="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/js/bootstrap.min.js"></script>
        <script src="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/js/owl.carousel.min.js"></script>
        <script src="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/js/wow.js"></script>
        <script src="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/js/main.js"></script>
</body>
</html>